...
async function login(username, password) {
  const response = await fetch("http://10.32.9.245:8000/login", {
    method: "POST",
    headers: {
...
async function logout() {
  ...
  const response = await fetch("http://10.32.9.245:8000/logout", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
async function show_current_user() {
  const token = getCookie();
  const response = await fetch("http://10.32.9.245:8000/current_user", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
function trackRequest() {
  ...
  fetch("http://10.32.9.245:8000/check_status", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
async function showRequestsAll() {
  ...
  try {
    // Fetch data from the server
    const response = await fetch(
      "http://10.32.9.245:8000/show_requests_student",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
